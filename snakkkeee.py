...
def right():
    ...
    print("You pressed the dright key")
...
def move_snake():
    ...
    if len(food_stamps) <= 6 :
            make_food()
    turtle.ontimer(move_snake,TIME_STEP) #<--- new line her
    

turtle.register_shape("canddy.gif") #Add trash picture
                      # Make sure you have downloaded this shape 
                      # from the Google Drive folder and saved it
                      # in the same folder as this Python script

food = turtle.clone()
food.shape("canddy.gif") 
